...
import 'package:flutter_fundamental_dicoding/models/academy.dart';

class LearningPathPage extends StatelessWidget {
  static const routeName = '/ui_design/learning_path';
...
class SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  bool shouldRebuild(covariant SliverPersistentHeaderDelegate oldDelegate) {
    // var maxHeight;
    return maxHeight != oldDelegate.maxExtent || //oldDelegate.maxHeight ||
        minHeight != oldDelegate.minExtent;
    //||
    // child != oldDelegate.build(context, shrinkOffset, overlapsContent);
  }
}
